...
{
    public class FruitFalls : CCScene
    {
        ...
        public FruitFalls(CCGameView gameView) : base(gameView)
        {
        ...
        private void CreateForeground()
        {
            ...
            foreground.ContentSize = new CCSize(App.Width,App.Height);
        ...
        private void HandleTouchesBegan(List<CCTouch> arg1, CCEvent arg2)
        {
            if (hasGameEnded)
            {
                var newScene = new TitleScene(GameView);
